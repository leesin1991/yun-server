 ...
 */
class CategoryFictitiousModel extends Model{
    protected $trueTableName = 'm_category_fictitious';
    ...
    public function update(){
        ...
        //记录行为
        action_log('update_category', 'categoryfictitious', $data['id'] ? $data['id'] : $res, UID);

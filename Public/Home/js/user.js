...
function userLogin()
{
	...
	var reg_token = frm.find("input[name='reg_token']");
	...
	Ajax.call( 'user.php?act=act_login', 'username=' + username.val()+'&password='+password.val()+'&reg_token='+reg_token.val()+remember_string+'&captcha='+captcha.val()+'&back_act='+back_act, return_login , 'POST', 'JSON');
}

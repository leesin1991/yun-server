...
$(function(){
	...
	number = 0,											//数量	
	cartValue = $("input[name='goods_id']"),          //保存选中商品Id隐藏域
	...
	{   
		...
		Ajax.call('/Mall/Cart/cartInfo', 'goods_id=' + rec_id, change_cart_goods_response, 'POST','JSON');                
	}
	...
	function replace_cart_goods(rec_id, favourable_id, $this)
	{
		...
		Ajax.call('/Mall/Cart/cartInfo', 'goods_id=' + rec_id, replace_cart_goods_response, 'POST','JSON');                
	}
	...
	function total(goods_total,save_total,cartNum){
		$("*[ectype='goods_total'] b").html(goods_total); //商品总金额

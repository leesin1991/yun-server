...
//              return false;
//          }            
            layer.confirm('确认要执行该操作吗?', {btn: ['确定','取消']}, function(){
...
function highlight_subnav(url){
    $('.side-sub-menu').find('a[href="'+url+'"]').closest('li').addClass('current').parents(".side-sub-menu").show().prev("h3").find("i").removeClass("icon-fold").addClass("icon-unfold");
}
...
//		if(on==0){
//			$(".left_list").each(function(e){
//				if(!$(this).find(".side-sub-menu").is(":hidden")){
//					_indexs=e;
//					on++;
//				}
//			});
...
//			$(".side-sub-menu").stop(200).slideUp();
//			$(this).find(".side-sub-menu").stop(200).slideDown();	
//		}			
//	},function(){
//			$(this).find("i").removeClass("icon-unfold").addClass("icon-fold");
//			$(this).find(".side-sub-menu").stop(200).slideUp();		
//	});
//	
//	$("#subnav").mouseleave(function(){
//		$(".left_list").eq(_indexs).find(".side-sub-menu").stop(200).slideDown().prev("h3").find("i").removeClass("icon-fold").addClass("icon-unfold");	
//	})

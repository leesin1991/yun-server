...
//	var $alipay_gateway_new = 'https://openapi.alipaydev.com/gateway.do?';
	 ...
	 * @return 支付宝处理结果
	 */
	function buildRequestHttpPost($para_temp) {
		$sResult = '';
     ...
     * @return 支付宝处理结果
     */
    function buildRequestHttpGet($para_temp) {
        $url_str = '';
        ...
        //远程获取数据
        $sResult = getHttpResponseGET($this->alipay_gateway_new.$url_str, $this->alipay_config['cacert']);
